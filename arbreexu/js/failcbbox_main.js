...
GEOR.Addons.arbreexu.prototype = {
    ...
    onDescribeProcess: function(process) {
        ...
        if (table_L_input_scroll.length >= 1) {
            ...
            scroll_allowedValues.push(scroll1_allowedValues);  console.log(scroll_allowedValues); console.log(scroll_allowedValues[0][0][0]);
        }
    ...
    createWindow: function() {
        ...
        if (table_L_input_scroll.length >= 1) {
            champ_pour_input_scroll1 = new Ext.form.ComboBox(Ext.apply({
                ...
                store: new Ext.data.SimpleStore({
                    fields: ['value', 'text'],
                    data: [['Item'],['Location']]//scroll_allowedValues[0][0][0]//scroll_allowedValues[0]
                }),
				displayField: 'text',
				valueField: 'value',				
				//
